...
{
    public partial class SafetyInfo : System.Web.UI.Page
    {
        ...
        protected void butSave_Click(object sender, EventArgs e)
        {
            ...
            cu.Question = dropQuestion.SelectedItem.Text;
            cu.Answer = txtAnswer.Text;
            cu.ID = person.ID;
            if (BLL.CustomerBLL.UpdateCustomerPasswordQuestion(cu) > 0)
            {
